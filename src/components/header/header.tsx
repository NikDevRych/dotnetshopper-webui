...
export default function Header() {
  return (
    <header className="flex h-14 items-center justify-around gap-2 bg-gray-900">
      <Link
        href="/"
        className="hidden text-nowrap text-2xl font-bold text-gray-50 sm:block"
      >
        DotNet Shopper
      </Link>
      <div className="flex w-1/2 items-center gap-2">
        ...
        <input
          className="w-1/2 rounded-md p-1 text-lg md:w-full"
          type="text"
          placeholder="If find..."
        />
